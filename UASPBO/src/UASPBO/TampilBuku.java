...
public class TampilBuku extends javax.swing.JFrame {
    ...
    private void jButtonCetakActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonCetakActionPerformed
        ...
        if (jComboBox1.getSelectedIndex() == 0) {
            Query query = em.createQuery("SELECT b FROM Buku b WHERE b.isbn ILIKE '%" + jTextFieldCari.getText().toLowerCase() + "%'");
            List<Buku> result = query.getResultList();
            for (Buku buku : result) {
                model.addRow(new Object[]{buku.getIsbn(), buku.getJudulBuku(), buku.getTahunTerbit(), buku.getPenerbit()});
            }
            ...
            Query query = em.createQuery("SELECT b FROM Buku b WHERE b.judul ILIKE '%" + jTextFieldCari.getText().toLowerCase() + "%'");
            List<Buku> result = query.getResultList();
            for (Buku buku : result) {
                model.addRow(new Object[]{buku.getIsbn(), buku.getJudulBuku(), buku.getTahunTerbit(), buku.getPenerbit()});
            }
            ...
            Query query = em.createQuery("SELECT b FROM Buku b WHERE b.tahunTerbit ILIKE '%" + jTextFieldCari.getText().toLowerCase() + "%'");
            List<Buku> result = query.getResultList();
            for (Buku buku : result) {
                model.addRow(new Object[]{buku.getIsbn(), buku.getJudulBuku(), buku.getTahunTerbit(), buku.getPenerbit()});
            }
            ...
            Query query = em.createQuery("SELECT b FROM Buku b WHERE b.penerbit ILIKE '%" + jTextFieldCari.getText().toLowerCase() + "%'");
            List<Buku> result = query.getResultList();
            for (Buku buku : result) {
                model.addRow(new Object[]{buku.getIsbn(), buku.getJudulBuku(), buku.getTahunTerbit(), buku.getPenerbit()});
            }
    ...
    private void jTextFieldCariKeyReleased(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_jTextFieldCariKeyReleased
        ...
        if (jComboBox1.getSelectedIndex() == 0) {
            Query query = emf.createQuery("SELECT b FROM Buku b WHERE b.isbn ILIKE '%" + jTextFieldCari.getText().toLowerCase() + "%'");
            List<Buku> result = query.getResultList();
            for (Buku buku : result) {
                model.addRow(new Object[]{buku.getIsbn(), buku.getJudulBuku(), buku.getTahunTerbit(), buku.getPenerbit()});
            }
        } else if (jComboBox1.getSelectedIndex() == 1) {
            Query query = emf.createQuery("SELECT b FROM Buku b WHERE b.judulBuku ILIKE '%" + jTextFieldCari.getText().toLowerCase() + "%'");
            List<Buku> result = query.getResultList();
            for (Buku buku : result) {
                model.addRow(new Object[]{buku.getIsbn(), buku.getJudulBuku(), buku.getTahunTerbit(), buku.getPenerbit()});
            }
        } else if (jComboBox1.getSelectedIndex() == 2) {
            Query query = emf.createQuery("SELECT b FROM Buku b WHERE b.tahunTerbit ILIKE '%" + jTextFieldCari.getText().toLowerCase() + "%'");
            List<Buku> result = query.getResultList();
            for (Buku buku : result) {
                model.addRow(new Object[]{buku.getIsbn(), buku.getJudulBuku(), buku.getTahunTerbit(), buku.getPenerbit()});
            }
        } else if (jComboBox1.getSelectedIndex() == 3) {
            Query query = emf.createQuery("SELECT b FROM Buku b WHERE b.penerbit ILIKE '%" + jTextFieldCari.getText().toLowerCase() + "%'");
            List<Buku> result = query.getResultList();
            for (Buku buku : result) {
                model.addRow(new Object[]{buku.getIsbn(), buku.getJudulBuku(), buku.getTahunTerbit(), buku.getPenerbit()});
            }
