        ...
        if (i == JFileChooser.APPROVE_OPTION) {
            ...
            try {
                ...
                for (CSVRecord csvRecord : csvParser) {
                    ...
                    a.setId(csvRecord.get(0));
                    a.setNamaMhs(csvRecord.get(1));
                    a.setAlamat(csvRecord.get(2));
                    a.setTelepon(csvRecord.get(3));
    ...
    private void jButtonCetakActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonCetakActionPerformed
        ...
        if (jComboBox1.getSelectedIndex() == 0) {
            ...
            for (Anggota anggota : result) {
                model.addRow(new Object[]{anggota.getId(), anggota.getNamaMhs(), anggota.getAlamat(), anggota.getTelepon()});
            }
